...
public class SelectionForm : Form
{
    ...
    public SelectionForm()
    {
        ...
        // Set the form size to cover all screens
...
# Function to capture screenshot across all screens
function Capture-Screenshot {
    ...
    [System.Windows.Forms.Screen]::AllScreens | ForEach-Object {
        $totalBounds = [System.Drawing.Rectangle]::Union($totalBounds, $_.Bounds)
    }

    $screenshot = New-Object System.Drawing.Bitmap($totalBounds.Width, $totalBounds.Height)
    $graphics = [System.Drawing.Graphics]::FromImage($screenshot)
    $graphics.CopyFromScreen($totalBounds.Location, [System.Drawing.Point]::Empty, $totalBounds.Size)
    
    # Crop the screenshot to the selected bounds
    $croppedScreenshot = $screenshot.Clone($bounds, $screenshot.PixelFormat)
